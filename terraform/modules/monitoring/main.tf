...
# API Gateway alarms (if provided)
...
# CloudWatch Dashboard (fixed conditional types)
        ...
        tolist([
          {
            ...
            width  = 24
            height = 1
            properties = { markdown = "## ECS Services" }
          },
          {
            type = "metric"
            x    = 0
        ...
        tolist([
          {
            ...
            width  = 24
            height = 1
            properties = { markdown = "## RDS Database" }
          },
          {
            type = "metric"
            x    = 0
        ...
        tolist([
          {
            ...
            width  = 24
            height = 1
            properties = { markdown = "## Lambda Functions" }
          },
          {
            type = "metric"
            x    = 0
